package semaine02.exercices_corrige;
...
public class Pythagore {
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------");
        //Combiner les calculs comme demandé
    ...
    public int carreSommeCarre(int a,int b, int c) {
        ...
        //On aurait pu aussi utiliser calculerSomme deux fois mais ca semble un peu compliqué pour rien...
        return resultat;
    }
}
